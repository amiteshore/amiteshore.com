function ArchLinux() {
  document.title = "Arch Linux Installation";
  return (
    <main>
      ...
      <p>
        Check disk information with <code>lsblk</code> or <code>fdisk -l</code>.
      </p>
      ...
      <pre>
        # reflector -c "India" —download-timeout 60 -p http -p https —sort rate
        —save /etc/pacman.d/mirriorlist
      </pre>
